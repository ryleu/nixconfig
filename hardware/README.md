...
i own a few different machines, some of which will be present in the nix config at any
moment in time. here's a list:

- `barely-better`
  - Acer Aspire A515-43
  - this is the laptop that's getting me through college. unfortunately, it is not long
    for this world.
  - the name comes from the fact that it is marginally better than `mathrock`, the last
    free laptop that i owned and daily drove.
- `monument`
  - Dell PowerEdge R730
  - this is a server that chills in the basement. it operates mostly as a NAS and a
...
- `rectangle`
  - custom build hodgepodge of hardware
    ...
    - rx6700xt
  - mostly use this one for playing games. since getting `decknt`, i rarely use it. may
    repurpose into a nix build server as it's more powerful than `monument`.
...
- `ethernet-port`
  ...
  - this is a new laptop that i'm hoping will last me 10 years or so. its purpose is to
    replace `barely-better` for general computing tasks and writing code.
...
count those ones. i have other peripherals that come with me in my backpack.

- **keyboard:** i use an afternoon labs breeze with glorious pandas in it. it has a
  columnar stagger, which is more comfortable for me. you can find my qmk config
  [here](./afternoon_labs_breeze.json).
- **mouse:** i use a logitech lift for day-to-day use. it helps with my hand pain due
  to repetitive strain injuries from computing all day.
- **portable monitor:** i got a crummy 1080p portable monitor off of bestbuy that works
  excellently. i think the brand is AOC, but it's not stand out enough that i can
  recommend it.
